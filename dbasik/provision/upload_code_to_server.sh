...
rsync -avzh --exclude={'__pycache__/','tests/','driver/','logs/','.mypy_cache/','.pytest_cache/','.ropeproject/','.vagrant/','.idea','.git','.pytest_cache/*'} --delete ~/code/python/dbasik-dev/dbasik-dftgovernance/ dbasik@209.97.142.1:/dbasik/code/dbasik_dftgovernance/
